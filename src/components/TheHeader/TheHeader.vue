<template>
  <header class="w-full bg-white bg-glass-morphic">
    <div class="header-flex-container">
      <router-link to="/" class="rounded-3xl border-black items-center mb-4 sm:mb-0"><span class="text-meridian-gradient text-4xl">Plant-Guessr</span></router-link>
